class MockLoader
  ...
  def backend
    ...
    mock_files = {
      ...
      '/private/etc/sudoers' => mockfile.call('sudoers'),
      '/usr/local/etc/sudoers' => mockfile.call('sudoers'),
      '/etc/opt/sudoers' => mockfile.call('sudoers'),
      '/etc/security/sudoers' => mockfile.call('sudoers')
    }
    ...
    mock_cmds = {
      ...
      # sudoers resource
      'cat /etc/sudoers' => cmd.call('cat-etc-sudoers'),
      'cat /etc/sudoers /etc/sudoers.d/*' => cmd.call('cat-etc-sudoers-d'),
      'cat /private/etc/sudoers' => cmd.call('cat-etc-sudoers'),
      'cat /usr/local/etc/sudoers' => cmd.call('cat-etc-sudoers'),
      'cat /etc/opt/sudoers' => cmd.call('cat-etc-sudoers'),
      'cat /etc/security/sudoers' => cmd.call('cat-etc-sudoers')
    }
